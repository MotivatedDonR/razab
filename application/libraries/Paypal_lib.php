...
class Paypal_lib{
    ...
    function __construct(){
        ...
        $this->add_field('quantity', '8');
		$this->add_field('item_name', '8');
		$this->add_field('item_number', '8');
		$this->add_field('item_description', '8');
		$this->add_field('item_tax', '8');
		$this->add_field('item_price', '8');
		$this->add_field('details_tax', '8');
		$this->add_field('details_subtotal', '8');
		$this->add_field('amount','8');
		//$this->add_field('notify_url','8');
        $this->button('Pay Now!');
		//$this->ipn();
    }
