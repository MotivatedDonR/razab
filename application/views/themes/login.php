...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="<?php echo base_url();?>assets/themes/admin/plugins/iCheck/square/blue.css">
    <!-- Extra CSS -->
    <?php
    foreach($css as $file){
        echo "\n\t\t";
    ...
    <!-- iCheck -->
    <script src="<?php echo base_url();?>assets/themes/admin/plugins/iCheck/icheck.min.js"></script>
