...
<div class="login-box-body">
    ...
    <form action="<?php echo current_url();?>" method="post" id="login-form">
        ...
        <div class="row">
            <div class="col-xs-12">
                <button type="submit" id="sign-btn" class="btn btn-primary btn-block btn-flat">Sign In</button>
            </div>
            <!-- /.col -->
        </div>
    </form>

    <a href="<?php echo base_url();?>users/auth/forgot">I forgot my password</a><br>
