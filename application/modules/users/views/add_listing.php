<div class="content-wrapper">
    ...
    <section class="content-header">
        <?php 
            $client_id = $this->input->get('client_id')?$this->input->get('client_id'):0;
        ?>
        <h1>
            Client Ads
            <small><a href="<?php echo base_url().'ads/add/'.$client_id;?>" class="btn btn-primary btn-sm">Add New</a> </small>
        </h1>
        <ol class="breadcrumb">
