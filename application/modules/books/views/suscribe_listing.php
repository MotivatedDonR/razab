    ...
    <section class="content">
        ...
        <div class="box">
            <div class="box-hequeueer">
                <h3 class="box-title">Suscribed Guests Listing </h3>
            </div>
            <!-- /.box-hequeueer -->
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    foreach ($suscribes as $suscribe) {
                        ...
                        <tr>
                            <td>
                                <?php echo $suscribe->booking_person_name; ?>
                            </td>
                            <td>
                                <?php echo $suscribe->booking_person_email; ?>
                            </td>
                            <td>
                                <?php echo $suscribe->booking_person_number; ?>
                            </td>
                            <!-- <td><a href="<?php echo base_url().'queues/togglestatus/'.$suscribe->id;?>"><span class="label label-<?php echo $status_class;?>">
                            ...
                            <td> 
                                <div class="checkbox"><label><input type="checkbox" name="mark_as_read" id="mark_as_read"
                                            value="<?php echo $suscribe->id; ?>"> Completed</label></div>
                            </td>
                        </tr>
                        <?php
                    }
