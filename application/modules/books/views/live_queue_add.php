    ...
    <section class="content">
        ...
        <div class="box box-info">
            <div class="box-header with-border">
                <h3 class="box-title">Enter Live Queue</h3>
            </div>
            <div id="suc_msg"></div>
            ...
            <div class="box-body">
                <div class="row clearfix">
                  ...
                  <input type="hidden" name="MERCHANT_RESPONSE_URL" value="<?php echo base_url('books/live_queue_payment_response')?>">
            ...
            <div class="box-footer">
                <?php if($ads->price==0){?>                    
                    <button type="button" class="btn btn-success live_queue">Enter Live Queue </button>    
                <?php }else{ ?>
                    <button type="button" class="btn btn-success via_payment"> Enter Live Queue </button>
                <?php } ?>  
...
<script type="text/javascript">
    ...
    function validation() {
        ...
        // if (show_time == '') {
        //     $('#varify_date').html('<div style="color:red;">Please Select Appointment Date .</div>');
        // } else {
        //     date_flag = 1;
        //     $('#varify_date').html('');
        // }
    ...
    function in_live_queue() {
        console.log("in live queeu");
        var name = $('#name').val();
        var email = $('#email').val();
        var number = $('#number').val();
        var client_id = $('#client_id').val();
        ...
        // retrun
        $.post("<?php echo base_url('books/add_live_queue');?>", {
                name: name,
                email: email,
                number: number,
                client_id: client_id,
            ...
            .done(function (data) {
                console.log(data);
                location.href = "<?php echo base_url('books/live_queue_position/')?>"+data+'/'+ad_id;
                    // $('#suc_msg').html(
                    //     '<div class="alert alert-success alert-dismissible"><a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a><strong>Success!</strong> You Have Successfully Entered in Live Queue.</div>'
                    // );
