...
class Book extends CI_Model {
  ...
  public function check_queue_exist($ad_id,$appo_date_time)
    ...
    public function mail($admin_email,$email_sender_name,$email_send_text,$ad_id, $appo_date,$appo_time, $appo_date_time, $last_id, $booking_person_email,$booking_person_name,$advertiser_name){
        ...
        // echo'<pre>';
        // print_r($booking_person_name);
        //$booking_person_name = str_replace(' ', '%20', $booking_person_name);
        $adv_name = str_replace(' ', '%20', $advertiser_name);
        
        
        // echo (new DateTime($appo_date_time))->format('Y-m-d H:i:s\Z');
        // die;
        $date_time =(new DateTime($appo_date_time))->format('Y-m-d H:i:s\Z');
        $date_time = preg_replace('/[^A-Za-z0-9\. -]/', '', $date_time);
        $date_time =substr($date_time, 0, -1);
        ...
        <p>'.$email_send_text.' '.'<strong>'.$advertiser_name.'</strong>.</p></br>
         <a href="http://www.google.com/calendar/event?action=TEMPLATE&text=Appointment%20With%20'.$adv_name.'&dates='.$date_time.'Z/'.$date_time.'Z'.'&details=Booking%20Details%20Here&location=123%20Main%20St%2C%20Booking%2C%20NY">Add to Google Calender</a>
        <h3>When:</h3></br>
        ...
        <p><h3>How to Cancel:</h3> <a href="'.base_url().'books/cancel?cid='.$last_id.'">Click Here</a> </p></br>';
    ...
    public function live_queue_mail($admin_email,$email_sender_name,$email_send_text,$ad_id, $last_id, $booking_person_name, $booking_person_email, $advertiser_name){
        ...
        <a href="http://www.google.com/calendar/event?action=TEMPLATE&text=Appointment%20with%20'.$adv_name.'&details=Booking%20Details%20Here&location=123%20Main%20St%2C%20Booking%2C%20NY">Add to Google Calender</a>';
    ...
    // public function add_payment($params_1){

    //     $this->db->insert('payments',$params_1);
    // }
    public function add_payment($params_1){
        // echo"enter modle";
        // die;
