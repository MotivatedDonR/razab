            ...
            <div class="box-body">
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    foreach ($queues as $queue) {
                        ...
                        <tr>
                            <td>
                                <?php echo $queue->booking_person_name; ?>
                            </td>
                            <td>
                                <?php echo $queue->booking_person_email; ?>
                            </td>
                            <td>
                                <?php echo $queue->booking_person_number; ?>
                            </td>
                            <!-- <td><a href="<?php echo base_url().'queues/togglestatus/'.$queue->id;?>"><span class="label label-<?php echo $status_class;?>">
                            ...
                            <td> 
                                <div class="checkbox"><label><input type="checkbox" name="mark_as_read" id="mark_as_read"
                                            value="<?php echo $queue->id; ?>"> Completed</label></div>
                            </td>
                        </tr>
                        <?php
                    }
