                ...
                <div class="row clearfix">
                    ...
                    <div class="col-md-6">
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="address" value="<?php echo $this->input->post('address'); ?>" class="form-control"  onFocus="geolocate()" id="address" />
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="text" name="manager_name" value="<?php echo $this->input->post('manager_name'); ?>" class="form-control" id="manager_name" />
					...
					<div class="col-md-6">
                        ...
                        <div class="form-group">
                            <input type="number" name="fax" value="<?php echo $this->input->post('fax'); ?>" class="form-control" id="fax" />
