...
function readURL(input) {
  ...
  if (input.files && filesAmount==1 ) {
    ...
    reader.onload = function(e) {
        ...
        // $("#img").append("<div class='row'><input type='button' style='margin-left: 25px;' class='btnRotate' value='90' onClick='rotateImage(this.value);' /><input type='button' class='btnRotate' value='-90' onClick='rotateImage(this.value);' /><input type='button'class='btnRotate' value='180' onClick='rotateImage(this.value);' /><input type='button' class='btnRotate' value='360' onClick='rotateImage(this.value);' /></div><div class='row'  id='new' style='margin-left:30px;width: 100px;height: 100px;overflow: hidden;border: 1px solid black;margin-left: 20px;id=;'   ><input type='text'  name='degree' value='' id='degree'><img src='#' id='blah' alt='img'></div");
        ...
        var x = 0 ;
         for (i = 0; i < filesAmount; i++) {
                ...
                reader.onload = function(event) {
                     x++;
                    $("#img").append("<div class='row'><input type='button' class='btnRotate' style='margin-left:30px;' value='90' onClick='rotateImage(this.value);' /><input type='button' class='btnRotate' value='-90' onClick='rotateImage(this.value);' /><input type='button'class='btnRotate' value='180' onClick='rotateImage(this.value);' /><input type='button' class='btnRotate' value='360' onClick='rotateImage(this.value);' /><div class='row' id='new' style='margin-left:30px;width: 100px;height: 100px;overflow: hidden;border: 1px solid black;margin-left: 20px;id=;'  ><input type='text'  name='degree' value='' id='degree'><img src='#' id='my"+ x +"' alt='img'></div></div>");
                        //$('#my"+ x +"').attr('src', e.target.result);
